...
namespace SpareParts.Tester.DataServiceClient {
    ...
    public interface IDataService {
        ...
        SpareParts.Dto.ProductViewDto[] SearchProduct(string productType, string brand, string category, string subCategory1, string subCategory2, string model, string subModel, string item, string state, string[] years, string vin);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDataService/SearchProduct", ReplyAction="http://tempuri.org/IDataService/SearchProductResponse")]
        System.Threading.Tasks.Task<SpareParts.Dto.ProductViewDto[]> SearchProductAsync(string productType, string brand, string category, string subCategory1, string subCategory2, string model, string subModel, string item, string state, string[] years, string vin);
        ...
        SpareParts.Dto.ProductViewDto[] SearchSellableProducts(string productType, string brand, string category, string subCategory1, string subCategory2, string model, string subModel, string item, string state, string[] years, string vin);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDataService/SearchSellableProducts", ReplyAction="http://tempuri.org/IDataService/SearchSellableProductsResponse")]
        System.Threading.Tasks.Task<SpareParts.Dto.ProductViewDto[]> SearchSellableProductsAsync(string productType, string brand, string category, string subCategory1, string subCategory2, string model, string subModel, string item, string state, string[] years, string vin);
        ...
        SpareParts.Dto.CategoryViewDto[] GetCategoriesByProductType(int productTypeId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDataService/GetCategoriesByProductType", ReplyAction="http://tempuri.org/IDataService/GetCategoriesByProductTypeResponse")]
        System.Threading.Tasks.Task<SpareParts.Dto.CategoryViewDto[]> GetCategoriesByProductTypeAsync(int productTypeId);
        ...
        bool DeleteCategory(SpareParts.Dto.CategoryDto dto);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDataService/DeleteCategory", ReplyAction="http://tempuri.org/IDataService/DeleteCategoryResponse")]
        System.Threading.Tasks.Task<bool> DeleteCategoryAsync(SpareParts.Dto.CategoryDto dto);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IDataServiceChannel : SpareParts.Tester.DataServiceClient.IDataService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DataServiceClient : System.ServiceModel.ClientBase<SpareParts.Tester.DataServiceClient.IDataService>, SpareParts.Tester.DataServiceClient.IDataService {
        ...
        public SpareParts.Dto.ProductViewDto[] SearchProduct(string productType, string brand, string category, string subCategory1, string subCategory2, string model, string subModel, string item, string state, string[] years, string vin) {
            return base.Channel.SearchProduct(productType, brand, category, subCategory1, subCategory2, model, subModel, item, state, years, vin);
        }
        
        public System.Threading.Tasks.Task<SpareParts.Dto.ProductViewDto[]> SearchProductAsync(string productType, string brand, string category, string subCategory1, string subCategory2, string model, string subModel, string item, string state, string[] years, string vin) {
            return base.Channel.SearchProductAsync(productType, brand, category, subCategory1, subCategory2, model, subModel, item, state, years, vin);
        }
        
        public SpareParts.Dto.ProductViewDto[] SearchSellableProducts(string productType, string brand, string category, string subCategory1, string subCategory2, string model, string subModel, string item, string state, string[] years, string vin) {
            return base.Channel.SearchSellableProducts(productType, brand, category, subCategory1, subCategory2, model, subModel, item, state, years, vin);
        }
        
        public System.Threading.Tasks.Task<SpareParts.Dto.ProductViewDto[]> SearchSellableProductsAsync(string productType, string brand, string category, string subCategory1, string subCategory2, string model, string subModel, string item, string state, string[] years, string vin) {
            return base.Channel.SearchSellableProductsAsync(productType, brand, category, subCategory1, subCategory2, model, subModel, item, state, years, vin);
        }
        ...
        public SpareParts.Dto.CategoryViewDto[] GetCategoriesByProductType(int productTypeId) {
            return base.Channel.GetCategoriesByProductType(productTypeId);
        }
        
        public System.Threading.Tasks.Task<SpareParts.Dto.CategoryViewDto[]> GetCategoriesByProductTypeAsync(int productTypeId) {
        ...
        public bool DeleteCategory(SpareParts.Dto.CategoryDto dto) {
            return base.Channel.DeleteCategory(dto);
        }
        
        public System.Threading.Tasks.Task<bool> DeleteCategoryAsync(SpareParts.Dto.CategoryDto dto) {
            return base.Channel.DeleteCategoryAsync(dto);
        }
